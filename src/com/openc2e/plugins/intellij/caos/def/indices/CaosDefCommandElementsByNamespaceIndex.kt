...
class CaosDefCommandElementsByNamespaceIndex : CaosScriptCaseInsensitiveStringIndexBase<CaosDefCommandDefElement>(CaosDefCommandDefElement::class.java) {
    ...
    companion object {
        ...
        @JvmStatic
        val Instance = CaosDefCommandElementsByNamespaceIndex()
    }
