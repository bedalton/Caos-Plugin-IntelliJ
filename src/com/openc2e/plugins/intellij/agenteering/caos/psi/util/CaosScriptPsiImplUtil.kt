package com.openc2e.plugins.intellij.agenteering.caos.psi.util
...
import com.openc2e.plugins.intellij.agenteering.caos.psi.impl.CaosScriptExpectsQuoteStringImpl
...
import com.openc2e.plugins.intellij.agenteering.caos.references.*
...
enum class CaosScriptNamedGameVarType(val value: Int, val token: String) {
    UNDEF(-1, com.openc2e.plugins.intellij.agenteering.caos.psi.util.UNDEF),
    NAME(1, "NAME"),
    EAME(2, "EAME"),
    GAME(3, "GAME"),
    MAME(4, "MAME");
