...
import com.openc2e.plugins.intellij.agenteering.caos.fixes.*
import com.openc2e.plugins.intellij.agenteering.caos.indices.CaosScriptSubroutineIndex
...
class CaosScriptSyntaxErrorAnnotator : Annotator {
    ...
    private fun annotateComment(variant: CaosVariant, element: PsiComment, annotationWrapper: AnnotationHolderWrapper) {
        if (variant !in VARIANT_OLD)
            return
