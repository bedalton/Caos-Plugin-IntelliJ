...
public interface CaosScriptIcons {
    Icon SDK_ICON = IconLoader.getIcon("/icons/sdk-icon.png");
    Icon MODULE_ICON = IconLoader.getIcon("/icons/sdk-icon.png");
    ...
    Icon BLK_FILE_ICON = IconLoader.getIcon("/icons/blk-file-icon.png");
    ...
    Icon ATT_GROUP = IconLoader.getIcon("/icons/att-group-icon.png");
}
