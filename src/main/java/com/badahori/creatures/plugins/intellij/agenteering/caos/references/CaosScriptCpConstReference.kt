...
class CaosScriptCpConstReference(element: CaosScriptCpConst) : PsiReferenceBase<CaosScriptCpConst>(element, TextRange.create(1, element.textLength)) {

    private val isDeclaration by lazy {
        myElement.parent is CaosScriptCpConstDeclaration
    }
    ...
    override fun resolve(): PsiElement? {
        ...
        //if (resolvedElement == myElement)
          //  return null
        return PsiTreeUtil
                .collectElementsOfType(myElement.containingFile, CaosScriptCpConstDeclaration::class.java)
                .firstOrNull {
                    isReferenceTo(it)
                }
    }
