...
class CaosScriptHighlighterAnnotator : Annotator {
    ...
    override fun annotate(element: PsiElement, annotationHolder: AnnotationHolder) {
        ...
        when {
            (element is CaosScriptIsRvalueKeywordToken || element.parent is CaosScriptIsRvalueKeywordToken) && element.firstChild?.elementType != CaosScriptTypes.CaosScript_TOKEN -> colorize(element, wrapper, CaosScriptSyntaxHighlighter.RVALUE_TOKEN)
