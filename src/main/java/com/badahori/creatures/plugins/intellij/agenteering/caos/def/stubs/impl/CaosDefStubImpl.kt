...
data class CaosDefVariableTypeStruct private constructor(
    val type: String,
    ...
    companion object {
        private val mPool = mutableMapOf<String, CaosDefVariableTypeStruct>()

        fun get(
            type: String,
            valuesList: String? = null,
            noteText: String? = null,
            intRange: Pair<Int, Int>? = null,
            fileTypes: List<String>? = null,
            length: Int? = null
        ): CaosDefVariableTypeStruct {
            val key = "$type|$valuesList|$noteText|${intRange?.first}|${intRange?.second}|${fileTypes?.joinToString { it }}|$length"
            return mPool[key] ?: CaosDefVariableTypeStruct(
                type,
                valuesList,
                noteText,
                intRange,
