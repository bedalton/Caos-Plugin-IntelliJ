...
public class DDEClientConversation {
    ...
    /**
     * Request service for specified item with specified clipboard format.
     *
     * @param item item name
     * @param wFmt Specifies the standard clipboard format of the data.
     * @return Item data.
    ...
    public synchronized byte[] request(String item, int wFmt) throws DDEException {
        ...
        return nativeRequest(item, wFmt);
    }
    ...
    private synchronized native byte[] nativeRequest(String item, int wFmt) throws UnsatisfiedLinkError, DDEException;
