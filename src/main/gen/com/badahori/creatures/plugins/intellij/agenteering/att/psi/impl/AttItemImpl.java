...
public class AttItemImpl extends AttCompositeElementImpl implements AttItem {

  public AttItemImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public AttErrorValue getErrorValue() {
    return findChildByClass(AttErrorValue.class);
  }

  @Override
  @Nullable
  public AttInt getInt() {
    return findChildByClass(AttInt.class);
  }
