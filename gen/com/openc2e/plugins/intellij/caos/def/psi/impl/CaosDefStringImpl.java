...
public class CaosDefStringImpl extends CaosDefCompositeElementImpl implements CaosDefString {

  public CaosDefStringImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public CaosDefStringBody getStringBody() {
    return findNotNullChildByClass(CaosDefStringBody.class);
  }
