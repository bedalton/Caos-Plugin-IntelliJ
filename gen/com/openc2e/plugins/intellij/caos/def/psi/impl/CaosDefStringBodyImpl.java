...
public class CaosDefStringBodyImpl extends CaosDefCompositeElementImpl implements CaosDefStringBody {

  public CaosDefStringBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaosDefVisitor visitor) {
    visitor.visitStringBody(this);
  }
