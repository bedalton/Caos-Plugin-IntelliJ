...
public class CaosDefInlineDocCommentImpl extends CaosDefCompositeElementImpl implements CaosDefInlineDocComment {

  public CaosDefInlineDocCommentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaosDefVisitor visitor) {
    visitor.visitInlineDocComment(this);
  }
